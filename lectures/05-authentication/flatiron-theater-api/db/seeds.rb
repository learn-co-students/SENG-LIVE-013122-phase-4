...
u3 = User.create(name:'ted', email:'ted@gmail.com')
u4 = User.create(name:'bill', email:'bill123@gmail.com')
u5 = User.create(name:'ridly', email:'aliens_r_4real@gmail.com')
u6 = User.create(name:'bishop', email:'not_a_robot@gmail.com')
